...
unzip(file.path(onedrive,"Data/CREDS Data/EPC Certificates/all-domestic-certificates-2022-08-26.zip"), 
...
certs_all <- data.table::rbindlist(certs, fill = TRUE)

saveRDS(certs_all, "data/epc_all_raw.Rds")
